...
var luisRecognizer = new builder.LuisRecognizer('https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/58022ea1-64ea-4d66-b640-9399f8ba52d6?subscription-key=a6fd1fc1f9b44ce59c019c40ad5a21a0&staging=true&verbose=true&timezoneOffset=3.0&q=');
var intentDialog = new builder.IntentDialog({recognizers: [luisRecognizer]});

var BINGSEARCHKEY = '55d7ae16cb1e41deab02dbac85e9dff5';
...
bot.dialog('/sayHi', function(session) {
    session.send('Hi there!  Try saying things like "Get news in Japan"');
    session.endDialog();
});
